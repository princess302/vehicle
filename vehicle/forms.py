...
class DriverForm(forms.ModelForm):
    class Meta:
        model = models.Customer  # This is now representing a Driver
        fields = ['address', 'mobile', 'profile_pic', 'employee_id', 'employment_status', 'driver_license_number']

class VehicleForm(forms.ModelForm):
    class Meta:
        model = models.Vehicle
        fields = ['registration_number', 'make_model', 'fuel_type', 'status']

class RouteForm(forms.ModelForm):
    class Meta:
        model = models.Route
        fields = ['route_id', 'origin', 'destination', 'distance', 'estimated_travel_time']
